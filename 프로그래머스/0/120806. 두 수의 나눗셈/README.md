...
### 두 수의 나눗셈
- 입력: 정수 num1, num2
- 출력: num1을 num2로 나눈 값에 1,000을 곱한 후 정수 부분을 반환
- 제약 조건: 0 < num1, num2 <= 100

***
<p>나눈 값을 result로 받은 후 1000을 곱한 값을 result1000에 저장 후 answer에 정수 부분만 저장한다</p> 
<p>-> answer 하나로도 처리할 수 있겠네</p>
<p>-> 식으로 다시 정리하면 answer = int((num1 / num2) * 1000) (파이썬)</p>

(나중에 다른 방식으로도 할 수 있으니 고민해보기)
***
